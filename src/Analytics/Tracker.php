...
class Tracker {
	 ...
	 *
	 * @deprecated Use Settings::OPTION instead.
	 *
	 * @var string
	 */
	public const OPTION = Settings::OPTION;

	/**
	 * Default settings.
	 *
	 * @deprecated Use Settings::DEFAULTS instead.
	 *
	 * @var array<string, mixed>
	 */
	public const DEFAULTS = Settings::DEFAULTS;
